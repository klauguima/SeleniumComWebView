...
public class TesteRegrasCadastro {
	...
	public static Collection<Object[]> getCollection() {
		return Arrays.asList(new Object[][] { { "", "", "", Arrays.asList(), new String[] {}, "Nome eh obrigatorio" },
				{ "Claudia", "", "", Arrays.asList(), new String[] {}, "Sobrenome eh obrigatorio" },
				{ "Claudia", "Guimaraes", "", Arrays.asList(), new String[] {}, "Sexo eh obrigatorio" },
				{ "Claudia", "Guimaraes", "Feminino", Arrays.asList("Carne", "Vegetariano"), new String[] {},
						"Tem certeza que voce eh vegetariano?" },
				{ "Claudia", "Guimaraes", "Feminino", Arrays.asList("Carne"),
